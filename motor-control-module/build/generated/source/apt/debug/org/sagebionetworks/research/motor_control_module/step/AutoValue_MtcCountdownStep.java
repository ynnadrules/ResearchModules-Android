...
final class AutoValue_MtcCountdownStep extends $AutoValue_MtcCountdownStep {
  AutoValue_MtcCountdownStep(ImmutableSet<AsyncActionConfiguration> asyncActions, String identifier,
    ...
    super(asyncActions, identifier, actions, hiddenActions, detail, footnote, text, title, colorTheme, imageTheme, commands, duration, spokenInstructions, backgroundAudioRequired, isFirstRunOnly);
  }

  public static final class GsonTypeAdapter extends TypeAdapter<MtcCountdownStep> {
    ...
    private boolean defaultIsFirstRunOnly = false;
    public GsonTypeAdapter(Gson gson) {
      this.gson = gson;
    }
    @Override
    @SuppressWarnings("unchecked")
    public void write(JsonWriter jsonWriter, MtcCountdownStep object) throws IOException {
      if (object == null) {
      ...
      jsonWriter.name("isFirstRunOnly");
      {
        TypeAdapter<Boolean> boolean__adapter = this.boolean__adapter;
        if (boolean__adapter == null) {
          this.boolean__adapter = boolean__adapter = gson.getAdapter(Boolean.class);
        }
        boolean__adapter.write(jsonWriter, object.getIsFirstRunOnly());
      }
      jsonWriter.endObject();
    }
    @Override
    @SuppressWarnings("unchecked")
    public MtcCountdownStep read(JsonReader jsonReader) throws IOException {
      ...
      boolean isFirstRunOnly = this.defaultIsFirstRunOnly;
      while (jsonReader.hasNext()) {
        ...
        switch (_name) {
          ...
          case "isFirstRunOnly": {
            ...
            isFirstRunOnly = boolean__adapter.read(jsonReader);
            break;
          }
          default: {
      ...
      return new AutoValue_MtcCountdownStep(asyncActions, identifier, actions, hiddenActions, detail, footnote, text, title, colorTheme, imageTheme, commands, duration, spokenInstructions, backgroundAudioRequired, isFirstRunOnly);
    }
    ...
    public GsonTypeAdapter setDefaultIsFirstRunOnly(boolean defaultIsFirstRunOnly) {
      this.defaultIsFirstRunOnly = defaultIsFirstRunOnly;
      return this;
    }
  }
}
