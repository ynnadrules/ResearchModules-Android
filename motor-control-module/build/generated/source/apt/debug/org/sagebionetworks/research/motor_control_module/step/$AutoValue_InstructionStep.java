...
abstract class $AutoValue_InstructionStep extends InstructionStep {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof InstructionStep) {
  ...
  @Override
  public InstructionStep.Builder toBuilder() {
    return new Builder(this);
  }

  static final class Builder extends InstructionStep.Builder {
    ...
    private Builder(InstructionStep source) {
    ...
    @Override
    public InstructionStep.Builder setAsyncActions(Set<AsyncActionConfiguration> asyncActions) {
      this.asyncActions = ImmutableSet.copyOf(asyncActions);
      return this;
    }
    @Override
    public InstructionStep.Builder setIdentifier(String identifier) {
      if (identifier == null) {
        throw new NullPointerException("Null identifier");
      }
      this.identifier = identifier;
    ...
    @Override
    public InstructionStep.Builder setActions(ImmutableMap<String, Action> actions) {
      if (actions == null) {
        throw new NullPointerException("Null actions");
      }
      this.actions = actions;
    ...
    @Override
    public InstructionStep.Builder setHiddenActions(ImmutableSet<String> hiddenActions) {
      if (hiddenActions == null) {
        throw new NullPointerException("Null hiddenActions");
      }
      this.hiddenActions = hiddenActions;
    ...
    @Override
    public InstructionStep.Builder setDetail(@Nullable String detail) {
      this.detail = detail;
      return this;
    }
    @Override
    public InstructionStep.Builder setFootnote(@Nullable String footnote) {
      this.footnote = footnote;
      return this;
    }
    @Override
    public InstructionStep.Builder setText(@Nullable String text) {
      this.text = text;
      return this;
    }
    @Override
    public InstructionStep.Builder setTitle(@Nullable String title) {
      this.title = title;
      return this;
    }
    @Override
    public InstructionStep.Builder setColorTheme(@Nullable ColorTheme colorTheme) {
      this.colorTheme = colorTheme;
      return this;
    }
    @Override
    public InstructionStep.Builder setImageTheme(@Nullable ImageTheme imageTheme) {
      this.imageTheme = imageTheme;
      return this;
    }
    @Override
    public InstructionStep.Builder setCommands(ImmutableSet<String> commands) {
      this.commands = commands;
      return this;
    }
    @Override
    public InstructionStep.Builder setDuration(@Nullable Double duration) {
      this.duration = duration;
      return this;
    }
    @Override
    public InstructionStep.Builder setSpokenInstructions(Map<String, String> spokenInstructions) {
      this.spokenInstructions = (spokenInstructions == null ? null : ImmutableMap.copyOf(spokenInstructions));
      return this;
    }
    @Override
    public InstructionStep.Builder setBackgroundAudioRequired(boolean backgroundAudioRequired) {
      this.backgroundAudioRequired = backgroundAudioRequired;
      return this;
    }
    @Override
    public InstructionStep.Builder setIsFirstRunOnly(boolean isFirstRunOnly) {
      this.isFirstRunOnly = isFirstRunOnly;
      return this;
    }
    @Override
    public InstructionStep build() {
      String missing = "";
      ...
      return new AutoValue_InstructionStep(
          this.asyncActions,
          this.identifier,
          this.actions,
          this.hiddenActions,
