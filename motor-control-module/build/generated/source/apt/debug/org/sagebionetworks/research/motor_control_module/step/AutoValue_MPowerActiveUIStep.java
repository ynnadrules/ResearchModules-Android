...
final class AutoValue_MPowerActiveUIStep extends $AutoValue_MPowerActiveUIStep {
  AutoValue_MPowerActiveUIStep(ImmutableSet<AsyncActionConfiguration> asyncActions,
  ...
  public static final class GsonTypeAdapter extends TypeAdapter<MPowerActiveUIStep> {
    ...
    public void write(JsonWriter jsonWriter, MPowerActiveUIStep object) throws IOException {
      if (object == null) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public MPowerActiveUIStep read(JsonReader jsonReader) throws IOException {
      ...
      return new AutoValue_MPowerActiveUIStep(asyncActions, identifier, actions, hiddenActions, detail, footnote, text, title, colorTheme, imageTheme, commands, duration, spokenInstructions, backgroundAudioRequired);
    }
