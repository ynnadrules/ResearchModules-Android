...
abstract class $AutoValue_MPowerActiveUIStep extends MPowerActiveUIStep {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof MPowerActiveUIStep) {
      MPowerActiveUIStep that = (MPowerActiveUIStep) o;
  ...
  @Override
  public MPowerActiveUIStep.Builder toBuilder() {
    return new Builder(this);
  }

  static final class Builder extends MPowerActiveUIStep.Builder {
    ...
    private Builder(MPowerActiveUIStep source) {
    ...
    @Override
    public MPowerActiveUIStep.Builder setAsyncActions(Set<AsyncActionConfiguration> asyncActions) {
      this.asyncActions = ImmutableSet.copyOf(asyncActions);
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setIdentifier(String identifier) {
      if (identifier == null) {
        throw new NullPointerException("Null identifier");
      }
      this.identifier = identifier;
    ...
    @Override
    public MPowerActiveUIStep.Builder setActions(Map<String, Action> actions) {
      this.actions = ImmutableMap.copyOf(actions);
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setHiddenActions(Set<String> hiddenActions) {
      this.hiddenActions = ImmutableSet.copyOf(hiddenActions);
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setDetail(@Nullable String detail) {
      this.detail = detail;
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setFootnote(@Nullable String footnote) {
      this.footnote = footnote;
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setText(@Nullable String text) {
      this.text = text;
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setTitle(@Nullable String title) {
      this.title = title;
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setColorTheme(@Nullable ColorTheme colorTheme) {
      this.colorTheme = colorTheme;
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setImageTheme(@Nullable ImageTheme imageTheme) {
      this.imageTheme = imageTheme;
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setCommands(Set<String> commands) {
      this.commands = (commands == null ? null : ImmutableSet.copyOf(commands));
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setDuration(@Nullable Double duration) {
      this.duration = duration;
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setSpokenInstructions(Map<String, String> spokenInstructions) {
      this.spokenInstructions = (spokenInstructions == null ? null : ImmutableMap.copyOf(spokenInstructions));
      return this;
    }
    @Override
    public MPowerActiveUIStep.Builder setBackgroundAudioRequired(boolean backgroundAudioRequired) {
      this.backgroundAudioRequired = backgroundAudioRequired;
      return this;
    }
    @Override
    public MPowerActiveUIStep build() {
      String missing = "";
      ...
      return new AutoValue_MPowerActiveUIStep(
          this.asyncActions,
          this.identifier,
          this.actions,
          this.hiddenActions,
