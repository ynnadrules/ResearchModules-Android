...
final class AutoValue_InstructionStep extends $AutoValue_InstructionStep {
  AutoValue_InstructionStep(ImmutableSet<AsyncActionConfiguration> asyncActions, String identifier,
  ...
  public static final class GsonTypeAdapter extends TypeAdapter<InstructionStep> {
    ...
    public void write(JsonWriter jsonWriter, InstructionStep object) throws IOException {
      if (object == null) {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public InstructionStep read(JsonReader jsonReader) throws IOException {
      ...
      return new AutoValue_InstructionStep(asyncActions, identifier, actions, hiddenActions, detail, footnote, text, title, colorTheme, imageTheme, commands, duration, spokenInstructions, backgroundAudioRequired, isFirstRunOnly);
    }
