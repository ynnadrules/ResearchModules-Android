...
abstract class $AutoValue_MtcCountdownStep extends MtcCountdownStep {
  ...
  @Override
  public boolean getIsFirstRunOnly() {
    return isFirstRunOnly;
  }

  @Override
  public String toString() {
    return "MtcCountdownStep{"
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof MtcCountdownStep) {
      MtcCountdownStep that = (MtcCountdownStep) o;
      return this.asyncActions.equals(that.getAsyncActions())
          ...
          && this.isFirstRunOnly == that.getIsFirstRunOnly();
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h$ *= 1000003;
    h$ ^= isFirstRunOnly ? 1231 : 1237;
    return h$;
  }

  @Override
  public MtcCountdownStep.Builder toBuilder() {
    return new Builder(this);
  }

  static final class Builder extends MtcCountdownStep.Builder {
    ...
    private Boolean isFirstRunOnly;
    Builder() {
    }
    private Builder(MtcCountdownStep source) {
      ...
      this.isFirstRunOnly = source.getIsFirstRunOnly();
    }
    @Override
    public MtcCountdownStep.Builder setAsyncActions(Set<AsyncActionConfiguration> asyncActions) {
      this.asyncActions = ImmutableSet.copyOf(asyncActions);
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setIdentifier(String identifier) {
      if (identifier == null) {
        throw new NullPointerException("Null identifier");
      }
      this.identifier = identifier;
    ...
    @Override
    public MtcCountdownStep.Builder setActions(Map<String, Action> actions) {
      this.actions = ImmutableMap.copyOf(actions);
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setHiddenActions(Set<String> hiddenActions) {
      this.hiddenActions = ImmutableSet.copyOf(hiddenActions);
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setDetail(@Nullable String detail) {
      this.detail = detail;
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setFootnote(@Nullable String footnote) {
      this.footnote = footnote;
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setText(@Nullable String text) {
      this.text = text;
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setTitle(@Nullable String title) {
      this.title = title;
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setColorTheme(@Nullable ColorTheme colorTheme) {
      this.colorTheme = colorTheme;
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setImageTheme(@Nullable ImageTheme imageTheme) {
      this.imageTheme = imageTheme;
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setCommands(Set<String> commands) {
      this.commands = (commands == null ? null : ImmutableSet.copyOf(commands));
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setDuration(@Nullable Double duration) {
      this.duration = duration;
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setSpokenInstructions(Map<String, String> spokenInstructions) {
      this.spokenInstructions = (spokenInstructions == null ? null : ImmutableMap.copyOf(spokenInstructions));
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setBackgroundAudioRequired(boolean backgroundAudioRequired) {
      this.backgroundAudioRequired = backgroundAudioRequired;
      return this;
    }
    @Override
    public MtcCountdownStep.Builder setIsFirstRunOnly(boolean isFirstRunOnly) {
      this.isFirstRunOnly = isFirstRunOnly;
      return this;
    }
    @Override
    public MtcCountdownStep build() {
      String missing = "";
      ...
      if (this.isFirstRunOnly == null) {
        missing += " isFirstRunOnly";
      }
      if (!missing.isEmpty()) {
        throw new IllegalStateException("Missing required properties:" + missing);
      }
      return new AutoValue_MtcCountdownStep(
          this.asyncActions,
          this.identifier,
          this.actions,
          this.hiddenActions,
